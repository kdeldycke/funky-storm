<? 
  ...
  // affichage des derniéres news
	$nb_news_to_show = 5; //on lui demande d'afficher les dix dernières news
	for($i = $max_news; ($i > ($max_news - $nb_news_to_show)) && ($i != 0); $i--) {
      ...
      $news_final_format .= "[<a href=\"$url\">$news_content[2]</a>] posté le $news_content[3]";  //écriture de la signature
  ...
  print("<center><a href=\"old_news.php\">Consulter les anciennes news</a></center><br><br><br>");
	...
	$forum_last_post .= " posté".($nb > 1 ? "s" : "")." aujourd'hui";
