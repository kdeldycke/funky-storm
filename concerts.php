...
<!-- debut de la zone de contenu principal -->
  ...
  <table border="0" cellpadding="2" cellspacing="1" width="100%">
	...
	<tr class="date">
      <td class="datedate">7 février 2004 à partir de 18h30</td>
    ...
    <tr class="date">
      <td class="datedate">17 mars 2004</td>
      <td class="dateinfo">Tremplin Funky Rock</td>
      <td class="dateinfo">Marly [59], France</td>
      <td class="datefoto">-</td>
      <td class="dateinfo">On attend les derniers détails...<br></td>
    </tr>
    	<tr><td colspan="5"><hr width="100%" size="1"></td></tr>
    <tr class="date">
      <td class="datedate">27 mars 2004 à 20h</td>
