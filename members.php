  ...
  $existenz = 0; //initialisation: le membre n'existe pas
    ...
    //debut de la zone de contenu principal
	  print_news_title("Les membres permanents de Funky Storm");
			$txt  = "";		
  	  $txt .= "<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Vous pouvez ici <i>admirer</i> les 5 musiciens de Funky Storm au travers de photos, où ils vous apparaîtront dans des positions les plus diverses et les plus insolites.<br>";
		  $txt .= "Ces même membres vous feront passer de l'amour à la haine, de la mélancolie à l'espoir et du rire à la pitié de part leurs réponses aussi farfelues que sincères, dans un questionnaire aux 72 questions pièges que les plus grands DRH de France et de Navarre nous envie.<br><br>" ;
  		$txt .= "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A prendre au x-ième degrés donc...<br><br>" ;
    ...
    $data_path = 'data/members/'.$member_id.'/'.$personal_data_file;
	  ...
	  if(!file_exists($data_path)) { //si fichier de données perso inexistant
	    $txt .= "<b>".$member_id."! Toi à qui cet espace perso est dédié, Qu'attend tu pour le remplir ?</b><br>signé: managueur.<br>"; //on gueule sur le membre !
